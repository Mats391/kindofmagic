...
namespace KindOfMagic.Tests
{
    ...
    public class Test
    {
        private void DoTest<T>(Action<Example, T> setter1, Action<TestMagic, T> setter2, string propName, T value1, T value2)
        {
        ...
        private void DoTestN<T>(Action<Example, T?> setter1, Action<TestMagic, T?> setter2, string propName, T value1, T value2) where T : struct
        {
            setter1(_test1, null);
            setter2(_test2, null);
        ...
        private Example _test1 = new Example();
        private TestMagic _test2 = new TestMagic();
